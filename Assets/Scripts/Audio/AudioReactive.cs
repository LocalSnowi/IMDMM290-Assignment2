...
public class AudioReactive : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i =0; i < numSphere; i++){
            ...
            float sin = Mathf.Sin(2 * i * Mathf.PI/numSphere);
            float cos = Mathf.Cos(2 * i * Mathf.PI/numSphere);
            endPosition[i] = new Vector3(r * sin * sin * sin * 1.25f, r * cos * cos * cos * 1.5f, 1.5f);
        }
